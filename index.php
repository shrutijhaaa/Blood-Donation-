...
<div class="event-wrapper">
    ...
    <div class="event-scroller">
        ...
        $query = "SELECT id, event_name, location, date, time, description FROM blood_donation_camps WHERE status='live' ORDER BY date ASC LIMIT 8";
    ...
    <div class="footer-container">
        ...
        <div class="footer-section">
            ...
            <ul>
                ...
                <li><a href="#">Voluntary Camps</a></li>
        ...
        <div class="footer-section">
            ...
            <div class="social-icons">
                <a href="#"><img src="images/facebook.jpg" alt="Facebook" class="social-icon"></a>
                <a href="#"><img src="images/twitter.png" alt="Twitter" class="social-icon"></a>
                <a href="#"><img src="images/instagram.jpg" alt="Instagram" class="social-icon"></a>
                <a href="#"><img src="images/linkedin.jpg" alt="LinkedIn" class="social-icon"></a>
            </div>
        </div>
    </div>
</footer>
